    ...
    <section class="about-us-area pt-100 pb-70">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="about-img">
              <img src="static/img/about-img.jpg" alt="Image">
            </div>
          </div>
          <div class="col-lg-6">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="protect-img">
              <img src="static/img/protect-img.jpg" alt="Image">
            </div>
          </div>
          <div class="col-lg-6">
      ...
      <div class="container">
        <div class="partner-slider owl-theme owl-carousel">
          <div class="partner-item">
            <a href="#">
              <img src="static/img/partner/partner-1.png" alt="Image">
            </a>
          </div>
          <div class="partner-item">
            <a href="#">
              <img src="static/img/partner/partner-2.png" alt="Image">
            </a>
          </div>
          <div class="partner-item">
            <a href="#">
              <img src="static/img/partner/partner-3.png" alt="Image">
            </a>
          </div>
          <div class="partner-item">
            <a href="#">
              <img src="static/img/partner/partner-4.png" alt="Image">
            </a>
          </div>
          <div class="partner-item">
            <a href="#">
              <img src="static/img/partner/partner-5.png" alt="Image">
            </a>
          </div>
        </div>
      </div>
